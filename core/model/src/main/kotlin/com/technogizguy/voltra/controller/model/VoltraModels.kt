...
data class VoltraReading(
    ...
    val directLoadSafetyStatus: Int? = null,
    val directLoadSafetyCountdownMillis: Int? = null,
    val directLoadSafetyControl: Int? = null,
    val directLoadEnabled: Boolean? = null,
    ...
    val rowingDriveForceLb: Double? = null,
    val rowingResistanceLevel: Int? = null,
    val rowingSimulatedWearLevel: Int? = null,
    val cardioActivityModeIndex: Int? = null,
    val skiResistanceLevel: Int? = null,
    val rowingTelemetryStartMillis: Long? = null,
    val rowingLastStrokeStartMillis: Long? = null,
    val rowingDistanceSamplesMeters: List<Double> = emptyList(),
    val rowingForceSamplesLb: List<Double> = emptyList(),
    val rowingForceLastChunkIndex: Int? = null,
    val workoutPeakForceLb: Double? = null,
    val workoutPeakPowerWatts: Int? = null,
    val workoutTimeToPeakMillis: Long? = null,
    val workoutLiveForceLb: Double? = null,
    val workoutLiveTick: Long? = null,
    val workoutPullStartTick: Long? = null,
    val workoutPeakForceTick: Long? = null,
...
enum class VoltraControlCommand {
    ...
    START_SKI,
    APPLY_CUSTOM_CURVE,
    SET_ROWING_RESISTANCE_LEVEL,
    SET_ROWING_SIMULATED_WEAR_LEVEL,
    SET_DAMPER_LEVEL,
